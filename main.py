...
def mitchell_fucks_up_the_plan():
    mitchell = Mitchell()
    dumbass_arogant_comment = mitchell.say("I'm going to murder you and your family unless you bow down to me!")
    reaction = ally_soon_to_be_enemy.react_to(dumbass_arogant_comment)
    return reaction
#
#
...
# that he demands control of Dontrell's operation - he can either submit or fight for control.
# mitchell_fucks_up_the_plan()
# Dontrell wasn't intimidated and asks Mitchell what he wants control of - Mitchell says everything and a battle ensues.
#   Dontrell transforms into a green skinned warlock. Mitchell took some damage from a
# surprise attack, then casts fire shield and teleports away towards the door. Sean sends himself into a rage then his
# tattoos glow as he channels fire into his attack. He swings his battleaxe in a sweep across the first person he sees.
# The axe sticks to his side. His next attack does critical damage and he ends up killing 3 total enemies and damages
# another. Teddy attacks the nearest enemy to him with his rapier and dagger - killing the enemy. Jason runs up and
# attacks the closest enemy. He sends a couple of punches then uses flurry of blows with his quarterstaff - the criminal
# grunt he targeted gets thrusted back into his ally and dies - his ally takes damage. Multiple archers shoot arrows at
# Mitchell and Jason - Mitchell takes full damage and Jason deflects the first arrow with deflect missile and takes
# damage. He sends the deflected arrow back at the enemy that shot the arrow and kills him. I call upon fire to light my
# sword and attack the nearest enemy. With two slashes I kill him.
...
# prevent me from attacking her. I cast zone of truth, and it blocks the spell. Lovaza tells me there's something I can
